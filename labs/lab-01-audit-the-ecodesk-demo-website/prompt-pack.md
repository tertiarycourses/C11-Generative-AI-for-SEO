# Prompt Pack — Lab 1: Audit the EcoDesk Demo Website
...
> **Task steps:** Audit the supplied HTML/CSS/JavaScript. Return observed evidence, severity, impact, confidence, verification and recommendation. Do not infer analytics or rankings.  
